...
class Subkriteria extends CI_Controller
{
    ...
    //             'nilai_minimum' => set_value('nilai_minimum',$row->nilai_minimum),
    //             'nilai_maksimum' => set_value('nilai_maksimum',$row->nilai_maksimum),
    //             'op_min' => set_value('op_min',$row->op_min),
    //             'op_max' => set_value('op_max',$row->op_max),
